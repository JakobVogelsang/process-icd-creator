...
class ProcessIcdCreator extends s$2 {
    ...
    render() {
      ...
      ></sld-viewer>
      <div
        class="${o$1({ lnode: true, selected: !!this.selectedTypeLNode })}"
      >
        ${this.substation
            ? x `${this.renderLinks()}`
      ...
      <div
        class="${o$1({ anyln: true, selected: !!this.selectedTypeLNode })}"
      >
        ${this.ied
            ? x `${this.renderICDSelection()}`
            : x `${this.renderICDInputs()}`}
      </div>
    </main>`;
    }
...
__decorate([
    t$1()
], ProcessIcdCreator.prototype, "selectedTypeLNode", void 0);
__decorate([
    t$1()
